...
('Plan Summary', 'Executive summary for the new venture: We are launching an innovative online platform that connects local artisans with global customers seeking unique handcrafted products. The problem we solve is the difficulty artisans face in reaching broader markets and the challenge consumers have in finding authentic handmade goods. Our solution provides a curated marketplace with built-in shipping logistics, secure payments, and marketing tools for sellers. The target market includes millennials and Gen Z consumers who value authenticity and sustainability. Our revenue model combines transaction fees at 12%, premium seller subscriptions, and featured listing promotions. Year one projections estimate 1000 active sellers and $2 million in gross merchandise value.', 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=400', 1, TRUE, '2024-08-20 11:00:00'),